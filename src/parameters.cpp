...
double wheel_vel_meas_cov;
std::vector<double> wheel_vel_rpy;
...
void readParameters(shared_ptr<rclcpp::Node> &nh)
{
    ...
    nh->declare_parameter<bool>("wheel.use_wheel_vel", false);
    nh->declare_parameter<std::string>("wheel.wheel_vel_topic", "/odom");
    nh->declare_parameter<double>("wheel.wheel_vel_meas_cov", 0.01);
    nh->declare_parameter<std::vector<double>>("wheel.wheel_vel_rpy", {0, 0, 0});
    ...
    nh->get_parameter("wheel.use_wheel_vel", use_wheel_vel);
    nh->get_parameter("wheel.wheel_vel_topic", wheel_vel_topic);
    nh->get_parameter("wheel.wheel_vel_meas_cov", wheel_vel_meas_cov);
    nh->get_parameter("wheel.wheel_vel_rpy", wheel_vel_rpy);
